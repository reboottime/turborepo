...
| Apps                 | Next.js 16.2.0 (App Router)        | Turbopack default bundler; `proxy.ts` replaces `middleware.ts`                                                                                                                  |
...
| Next.js 16            | https://nextjs.org/docs                                      | [App Router](https://nextjs.org/docs/app), [v16 upgrade guide](https://nextjs.org/docs/app/guides/upgrading/version-16)                                                               |
