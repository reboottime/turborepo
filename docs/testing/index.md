...
| File                                                                   | Purpose                                                                         |
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| [testing-strategy.md](testing-strategy.md)                             | Testing approach, coverage targets, CI pipeline order                           |
| [unit-testing-guidelines.md](unit-testing-guidelines.md)               | Unit test practices — snapshot tests, query priority, what to test              |
